...
CREATE TABLE `premiacion` (
  ...
  CONSTRAINT `premiacion_ibfk_1` FOREIGN KEY (`Premio`) REFERENCES `premio` (`Nombre`),
  CONSTRAINT `premiacion_ibfk_2` FOREIGN KEY (`Id_Actor`) REFERENCES `actores` (`IdActor`)
...
-- Dump completed on 2023-10-24 20:52:23
