...
CREATE TABLE `productora` (
  ...
  KEY `CEO` (`CEO`),
  KEY `Company` (`Company`),
  KEY `Distribu` (`Distribu`),
  CONSTRAINT `productora_ibfk_1` FOREIGN KEY (`CEO`) REFERENCES `ceo` (`idCEO`),
  CONSTRAINT `productora_ibfk_2` FOREIGN KEY (`Company`) REFERENCES `company` (`IdCompany`),
  CONSTRAINT `productora_ibfk_3` FOREIGN KEY (`Distribu`) REFERENCES `distribui` (`IdDistribui`)
...
-- Dump completed on 2023-10-24 20:52:22
